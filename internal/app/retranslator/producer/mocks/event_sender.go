...
// Source: github.com/aaa2ppp/ozonmp-education-kw-person-api/internal/app/retranslator/producer (interfaces: EventSender)
...
func (m *MockEventSender) Send(arg0 *person.PersonEvent) error {
	m.ctrl.T.Helper()
