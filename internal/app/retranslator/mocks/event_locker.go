...
// Source: github.com/aaa2ppp/ozonmp-education-person-api/internal/app/retranslator (interfaces: EventLocker)
...
func (m *MockEventLocker) Lock(arg0 uint64) ([]education.PersonEvent, error) {
	m.ctrl.T.Helper()
