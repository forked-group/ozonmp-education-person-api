...
// Source: github.com/aaa2ppp/ozonmp-education-kw-person-api/internal/app/repo (interfaces: EventRepo)
...
import (
	...
	person "github.com/aaa2ppp/ozonmp-education-kw-person-api/internal/model/person"
...
func (m *MockEventRepo) Add(arg0 []person.PersonEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]person.PersonEvent, error) {
	m.ctrl.T.Helper()
